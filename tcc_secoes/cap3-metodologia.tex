...
%         Desenvolvimento um \textit{datalogger} de baixo custo 
%         que seja capaz de ler temperatura, umidade relativa e luminosidade 
%         leituras sejam realizadas periodicamente de forma que o intervalo 
%         mínimo entre cada possa estar na casa dos segundos e devem ser
%          armazenadas em uma mídia de armazenamento de massa removível
%           para facilitar o resgate dessas informações posteriormente.
%     \end{block}
...
\begin{frame}{Fonte de alimentação}
    ...
    \only<1>{
        ...
        %     \begin{enumerate}
        %         \item Fornecer 3,3 V;
        %         \item Suportar alimentação por 4 pilhas AA;
