...
\begin{frame}[allowframebreaks]{Fonte de alimentação}
...
\begin{frame}[allowframebreaks]{Design PCI}
    ...
    %     \includegraphics[width=0.5\linewidth]{figuras/cap3/pcb/pcb_no_route.png}
    %     \source{Elaborado pelo autor}
